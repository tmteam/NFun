...
namespace NFun.Benchmarks
{
    public class SimplestArithmCalcBenchmark
    {
        ...
        [Benchmark]
        public TokFlow Lexing()
        {
            return Tokenizer.ToFlow(_expression);
        }
