...
/// <summary>
/// VM benchmark set — mirrors V1 exactly for honest TW vs VM comparison.
...
static class BenchSetVM {
    ...
    /// <summary>Same as V1 Medium — arrays, lambdas, user functions, structs.</summary>
    static BenchSubSet MediumVM() => new("Medium", 8, new BenchScript[]
    {
    ...
    /// <summary>Same as V1 Complex — recursion, bubble sort, heavy computation.</summary>
    static BenchSubSet ComplexVM() => new("Complex", 1, new BenchScript[]
    {
