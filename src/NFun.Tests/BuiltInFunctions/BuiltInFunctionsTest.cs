...
namespace Funny.Tests.BuiltInFunctions
{
    ...
    public class BuiltInFunctionsTest
    {
        ...
        [TestCase("[1,2,3,4].fold((acc,cur)->acc+cur)", 10.0)]
        [TestCase("[1,2,3,4].fold(0,(acc,cur)->acc+cur)", 10.0)]
        [TestCase("[1,2,3,4].fold(-10,(acc,cur)->acc+cur)", 0.0)]
        [TestCase("[1,2,3,4].fold('',(acc,cur)->'{acc}{cur}')", "1234")]
        [TestCase("any([])",false)]
