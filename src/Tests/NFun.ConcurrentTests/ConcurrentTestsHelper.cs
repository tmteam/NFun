...
public static class ConcurrentTestsHelper{
    ...
    public static void AssertStringTemplate(this StringTemplateCalculator origin, Action<StringTemplateCalculator> action)
    {
    ...
    public static void CalcContextInDifferentWays<TContext>(this string expr, TContext origin, TContext expected) where TContext:ICloneable {
    ...
    public static void CalcSingleTypedInDifferentWays<TInput, TOutput>(this string expr, TInput input, TOutput expected) {
