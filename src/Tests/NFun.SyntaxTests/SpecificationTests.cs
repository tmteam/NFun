...
y = tostring(x)", "y", "not supported")]
    ...
    public void Real_SingleEquationWithSingleInput(
        object xVal, string expression, string outputName,
        object outputValue) {
    ...
    [TestCase("y:int = [1,2,3,4].median()", "y", 2)]
    [TestCase("y:int = [10,20,30,40,50,60].median()", "y", 30)]
    [TestCase("y:int = [1,2,3].median()", "y", 2)]
    [TestCase("y:int = [5,10,15,20,25].median()", "y", 15)]
    [TestCase("y:int = [5,1,9,2,7].median()", "y", 5)]
    [TestCase("y:int = [9,8,7,6,5,4].median()", "y", 6)]
    [TestCase("y:int = [1,1,1,1].median()", "y", 1)]
    [TestCase("y:int = [3,3,3,4,4,4].median()", "y", 3)]
    [TestCase("y:int = [42].median()", "y", 42)]
    [TestCase("y:int = [-5,-2,-1,0,1,2].median()", "y", -1)]
    [TestCase("y:int = [-3,-2,-1].median()", "y", -2)]
    [TestCase("y:int = [1,2,3,4].median()", "y", 2)]
    [TestCase("y:int = [4,1,2,4,3,1].median()", "y", 2)]
    [TestCase("y:int = [0,0,0,1].median()", "y", 0)]
    [TestCase("y:int = [100, 200, 300, 400, 500, 600, 700].median()", "y", 400)]
    [TestCase("y:int = [9,8,7,6,5,4,3,2,1].median()", "y", 5)]
