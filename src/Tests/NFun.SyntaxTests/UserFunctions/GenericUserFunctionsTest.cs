...
public class GenericUserFunctionsTest {
    ...
    [TestCase("choise(a,b,takefirst) = if(takefirst) a else b\r y = choise(1,[1,2],false)",new[]{1,2})]
    [TestCase("choise(a,b,takefirst) = if(takefirst) a else b\r y:any = choise(1,[1,2],true)",(object)1.0)]
    [TestCase("choise(a,b,takefirst) = if(takefirst) a else b\r y:any = choise(1,[1,2],false)",new[]{1,2})]
