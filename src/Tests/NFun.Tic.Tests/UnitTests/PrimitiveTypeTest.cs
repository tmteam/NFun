...
public class PrimitiveTypeTest {
    ...
    [TestCase(Real, F32, Real)]
    // F32 — naïve LCA over the lattice: integer ∨ F32 = F32; F32 ∨ Real = Real.
    [TestCase(F32, I64, F32)]
    [TestCase(F32, I32, F32)]
    [TestCase(F32, I16, F32)]
    [TestCase(F32, I8,  F32)]
    [TestCase(F32, U64, F32)]
    [TestCase(F32, U32, F32)]
    [TestCase(F32, U16, F32)]
    [TestCase(F32, U8,  F32)]
