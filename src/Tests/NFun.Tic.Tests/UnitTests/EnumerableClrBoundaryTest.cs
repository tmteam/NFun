...
public class EnumerableClrBoundaryTest {
    ...
    [Test]
    public void BaseFunnyType_EnumerableSlot24() {
        Assert.AreEqual(24, (int)BaseFunnyType.Enumerable);
    }
    ...
    public void TypeBehaviour_StartupAssert_TableLengthMatchesEnum() {
        ...
        Assert.AreEqual(28, Enum.GetValues(typeof(BaseFunnyType)).Length);
    }
