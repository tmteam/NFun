...
namespace Nfun.Benchmarks
{
    public class NfunCalculateBenchmark
    {
        ...
        //public CalculationResult RunFakeNfun() => _kxruntime.CalculateFake(value);
        [Benchmark(Description = "dotnet kxb calc")] public double DotnetKxb() => dotnetEx(100);
        [Benchmark(Description = "dotnet summ1000 calc")] public int DotnetSum1000() => Enumerable.Range(1, 1000).Sum();
    }
}