...
namespace NFun
{
    public class FunnyCalculatorBuilder
    {
        ...
        public FunnyCalculatorBuilder WithFunction<Tin1, Tin2, Tin3, TOut>(string name,
        ...
        public FunnyCalculatorBuilder WithFunction<Tin1, Tin2, Tin3, Tin4, TOut>(string name,
        ...
        public FunnyCalculatorBuilder WithFunction<Tin1, Tin2, Tin3, Tin4, Tin5, TOut>(string name,
        ...
        public FunnyCalculatorBuilder WithFunction<Tin1, Tin2, Tin3, Tin4, Tin5, Tin6, TOut>(string name,
        ...
        public FunnyCalculatorBuilder WithFunction<Tin1, Tin2, Tin3, Tin4, Tin5, Tin6, Tin7, TOut>(string name,
