...
namespace NFun.InfinityProfiling.Sets
{
    public class ProfileBuildAllSet : IProfileSet
    {
        ...
        {
            Build(Scripts.PrimitiveConstIntSimpleArithmetics);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveConstRealSimpleArithmetics()
        {
            Build(Scripts.PrimitiveConstRealSimpleArithmetics);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveConstBoolSimpleArithmetics()
        {
            Build(Scripts.PrimitiveConstBoolSimpleArithmetics);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveCalcReal2Var()
        {
            Build(Scripts.PrimitiveCalcReal2Var);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveCalcInt2Var()
        {
            Build(Scripts.PrimitiveCalcInt2Var);
        }
        ...
        {
            Build(Scripts.ConstTrue);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitivesConstBool()
        {
            Build(Scripts.ConstBoolOp);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitivesConst1()
        {
            Build(Scripts.Const1);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstText()
        {
            Build(Scripts.ConstText);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstBoolArray()
        {
            Build(Scripts.ConstBoolArray);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstRealArray()
        {
            Build(Scripts.ConstRealArray);
        }
