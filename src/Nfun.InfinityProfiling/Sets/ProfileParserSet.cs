...
namespace NFun.InfinityProfiling.Sets
{
    public class ProfileParserSet : IProfileSet
    {
        ...
        {
            Parse(Scripts.ConstTrue);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitivesConstBool()
        {
            Parse(Scripts.ConstBoolOp);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitivesConst1()
        {
            Parse(Scripts.Const1);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstText()
        {
            Parse(Scripts.ConstText);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstBoolArray()
        {
            Parse(Scripts.ConstBoolArray);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstRealArray()
        {
            Parse(Scripts.ConstRealArray);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstInterpolation()
        {
            Parse(Scripts.ConstInterpolation);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstGenericFunc()
        {
            Parse(Scripts.ConstGenericFunc);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void ConstSquareEquation()
        {
            Parse(Scripts.ConstSquareEquation);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveConstIntSimpleArithmetics()
        {
            Parse(Scripts.PrimitiveConstIntSimpleArithmetics);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveConstRealSimpleArithmetics()
        {
            Parse(Scripts.PrimitiveConstRealSimpleArithmetics);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveConstBoolSimpleArithmetics()
        {
            Parse(Scripts.PrimitiveConstBoolSimpleArithmetics);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveCalcReal2Var()
        {
            Parse(Scripts.PrimitiveCalcReal2Var);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveCalcInt2Var()
        {
            Parse(Scripts.PrimitiveCalcInt2Var);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveCalcSingleBool()
        {
            Parse(Scripts.CalcSingleBool);
        }

        [MethodImpl(MethodImplOptions.NoOptimization)]
        public void PrimitiveCalcSingleReal()
        {
            Parse(Scripts.CalcSingleReal);
        }
