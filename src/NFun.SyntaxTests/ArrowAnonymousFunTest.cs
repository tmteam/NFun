...
namespace NFun.SyntaxTests
{
    ...
    public class ArrowAnonymousFunTest
    {
        ...
        [TestCase("y = [-1,-2,0,1,2,3].filter((rule it>0)).fold((i,j)-> i+j)", 6.0 )]
        [TestCase("y = [-1,-2,0,1,2,3].filter((rule it>0)).filter(i->i>2)", new[]{3.0})]
        [TestCase("y = [-1,-2,0,1,2,3].filter((rule it>0)).map(i->i*i).map(i:int->i*i)", new[]{1,16,81})]
        [TestCase("y = [-1,-2,0,1,2,3].filter((rule it>0)).map(i->i*i).map(i->i*i)", new[]{1.0,16.0,81.0})]

        [TestCase("y = [-1,-2,0,1,2,3].filter((rule it>0)).fold((a,b)-> a+b)", 6.0 )]
        [TestCase("y = [-1,-2,0,1,2,3].filter((rule it>0)).filter(a->a>2)", new[]{3.0})]
        [TestCase("y = [-1,-2,0,1,2,3].filter((rule it>0)).map(a->a*a).map(b->b*b)", new[]{1.0,16.0,81.0})]

        [TestCase("y = [-1,-2,0,1,2,3].filter(rule it>0).map(a->a*a).map(b:int->b*b)", new[]{1,16,81})]
        [TestCase("y = [-1,-2,0,1,2,3].filter(rule it>0).filter(a:int->a>2)", new[]{3})]
        [TestCase("y = [-1,-2,0,1,2,3].filter(rule it>0).fold((a:int,b)-> a+b)", 6 )]
