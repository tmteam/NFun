...
namespace NFun.SyntaxTests.BuiltInFunctions
{
    class LinqFunctionsTest
    {
        ...
        [TestCase(@"iSum(r:int, x:int):int = r+x
                     y = fold([100], iSum)", 100)]
        [TestCase("y:int = [1,2,3,4,5,6,7].filter((rule it.rema(2)==0)).sum()", 12)]
        [TestCase("y:int = [1,2,3,4,5,6,7].filter((rule it.rema(2)==0)).fold((rule it1+it2+1))", 14)]
        [TestCase("y:int = [1,2,3,4,5,6,7].filter(rule it.rema(2)==0).fold(rule it1+it2+1)", 14)]
        [TestCase("y:int = [1,2,3,4,5,6,7].filter(rule it.rema(2)==0).fold(min)", 2)]
        [TestCase("y:int = [1,2,3,4,5,6,7].filter((rule it.rema(2)==0)).fold(max)", 6)]
        ...
        [TestCase("y:int = [1,2,3,4,5,6,7].filter((rule it.rema(2)==0)).fold(rule if(it1>it2) it1 else it2)", 6)]
        [TestCase("y:int = [1,2,3,4,5,6,7].filter((rule it.rema(2)==0)).fold(rule 0)", 0)]
        [TestCase("y:int = [1,2,3,4,5,6,7].filter((rule it.rema(2)==0)).fold(rule 0)", 0)]
