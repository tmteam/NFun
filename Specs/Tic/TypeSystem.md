...
```
Unsigned: U8 ≤ U12 ≤ U16 ≤ U24 ≤ U32 ≤ U48 ≤ U64 ≤ Real
Signed:   I16 ≤ I24 ≤ I32 ≤ I48 ≤ I64 ≤ I96 ≤ Real
```

A signed type contains an unsigned only if its bit width is strictly larger. Otherwise the LCA lifts to the next abstract level (I24, I48, I96).
